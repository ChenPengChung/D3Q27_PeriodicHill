...
function Get-RemoteFiles {
    ...
    $excludeGrep = "grep -v '/.git/' | grep -v '/.vscode/' | grep -v '/a\.out$' | grep -v '\.o$' | grep -v '\.exe$' | grep -v '\.swp$' | grep -v '\.swo$' | grep -v '~$' | grep -v '__pycache__' | grep -v '\.pyc$' | grep -v '\.DS_Store' | grep -v '\.vtu$' | grep -v '/result/' | grep -v '/checkpoint/'"
